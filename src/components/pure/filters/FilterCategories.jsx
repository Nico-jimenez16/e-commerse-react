...
const FilterProductComponent = () => {
    ...
    const filterCategoriaHandler = (cat) => {
      ...
      <div className='w-full flex flex-col justify-center items-center p-3'>
        { 
            categorias.map((categoria , index) => {
              return(
                <div onClick={() => filterCategoriaHandler(categoria) } key={index} className='w-full flex justify-around items-center my-1 hover:text-cyan-600 cursor-pointer'>
                  <h3 className='w-1/6'> -
