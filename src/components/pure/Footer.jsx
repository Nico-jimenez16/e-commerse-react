            ...
            <div className="w-full h-full block flex justify-center md:justify-start items-center items-center pt-2">
              <div className="w-full md:w-1/2 flex justify-center items-center">
                ...
                <div className="flex justify-start items-center mt-1 mr-1">
                  ...
                  {/* <a href="mailto:jimeneznicolas520@gmail.com" target="_blank" rel="noopener noreferrer" > jimeneznicolas520@gmail.com </a> */}
                </div>
                <div className="flex justify-start items-center mt-1 mr-1">
                  <img className="w-6 mr-2" src="https://cdn-icons-png.flaticon.com/512/174/174857.png" alt="" />
                  {/* <a href="https://www.linkedin.com/in/jimenez-nicolas/" target="_blank" rel="noopener noreferrer" > https://www.linkedin.com/in/jimenez-nicolas/ </a> */}
                </div>
                <div className="flex justify-start items-center mt-1 mr-1">
                  ...
                  {/* <a href="https://github.com/Nico-jimenez16?tab=repositories" target="_blank" rel="noopener noreferrer"> github </a> */}
                </div>
              </div>
