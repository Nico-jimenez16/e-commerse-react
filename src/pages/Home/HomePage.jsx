      ...
      <>
        ...
        <div className='relative w-full h-full lg:h-96 flex justify-center items-center'>
          ...
          <div className='absolute w-full h-full flex flex-col justify-center items-start p-8'>
            <h1 className='text-5xl md:text-6xl font-serif'>VOTF</h1>
            <button onClick={ goProduct } className='text-xl text-black md:text-white border border-cyan-200 p-2 mt-4 hover:bg-cyan-200 hover:text-black'> Explore Products </button>
          </div>
        </div>
